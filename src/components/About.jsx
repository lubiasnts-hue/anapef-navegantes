    ...
    <section id="sobre" className="py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {/* Card 1 */}
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-8 text-center hover:shadow-xl transition transform hover:-translate-y-2">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-8 text-center hover:shadow-xl transition transform hover:-translate-y-2">
            ...
            <p className="text-gray-700">
              Empatia, solidariedade, transparência e compromisso com a transformação social.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-8 text-center hover:shadow-xl transition transform hover:-translate-y-2">
            ...
            <p className="text-gray-700">
              Uma rede de apoio formada por pessoas com fibromialgia, familiares e profissionais.
            </p>
          </div>
        </div>

        {/* History Section */}
        <div className="bg-gradient-to-r from-purple-700 to-purple-600 text-white rounded-xl p-12">
