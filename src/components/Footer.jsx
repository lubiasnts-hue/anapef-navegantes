        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#direitos" className="hover:text-white transition">Nossos Direitos</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li className="flex items-center space-x-2">
                <span>📞</span>
                <span>(47) 9752-0167</span>
              </li>
              <li className="flex items-center space-x-2">
                <span>📧</span>
                <span>contato@anapef.org.br</span>
              </li>
              <li className="flex items-center space-x-2">
                <span>📍</span>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-purple-700 p-3 rounded-full hover:bg-purple-800 transition transform hover:scale-110">
